...
\usepackage{graphicx}
\usepackage[font={sf,footnotesize},justification=raggedright]{caption}
...
One way to avoid it is to pad atomic variables with at least one cache line of
...
The title and captions are set in
\href{http://www.fontbureau.com/NHG/}{\textsf{Neue Haas Grotesk}},

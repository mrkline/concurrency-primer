...
In either of these cases, blocking for some arbitrary amount of time would be
unacceptable, so we need lock-free algorithms and data structures to communicate
with other threads.
(In the former case, the user's audio would begin to stutter if we do not

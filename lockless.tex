...
to prevent memory accesses from being rearranged in ways that break our
programs.
We've also seen how weakly-ordered architectures like \textsc{arm}
ensure this guarantee using a pair of memory barriers.
...
\end{minted}
\end{colfigure}
Non-sequentially consistent loads and stores use member functions of
...
Perhaps it is a pointer in the kernel to information about the peripherals

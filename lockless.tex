...
before the integer's new value is observable,
...
We've already seen acquire and release in action with the lock example
we just covered in \secref{lock-example}.

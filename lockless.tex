...
\section{Implementing atomic read-modify-write operations with \textsc{ll}/\textsc{sc} instructions}
...
\introduce{load-link} and \introduce{store-conditional} (\textsc{ll}/\textsc{sc}).
